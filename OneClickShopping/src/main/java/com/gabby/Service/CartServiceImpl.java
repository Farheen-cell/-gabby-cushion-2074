package com.gabby.allServicesImplementation;
...
import com.gabby.repository.CartRepo;
import com.gabby.repository.ProductRepo;
import com.gabby.services.CartService;
import com.gabby.services.LoginLogoutCustomerService;
				...
				if (optional_cart.isPresent()) {
					...
					if (!listofproducts.isEmpty()) {
						...
						if (flag == true) {
							...
							throw new ProductException("No Products Found In the Cart By This Product Id : " + productId);
						}
